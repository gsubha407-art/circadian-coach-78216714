  ...
  return (
    <div className="relative w-full">
      <SelectPrimitive.Trigger
        ...
        className={cn(
          "flex h-14 w-full items-center justify-between rounded-xs bg-transparent px-4 pt-4 pb-2 text-base ring-offset-background transition-all duration-short ease-standard [&>span]:line-clamp-1",
          isFocused
            ? error
